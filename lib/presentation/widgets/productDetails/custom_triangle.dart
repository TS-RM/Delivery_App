...
class CustomTriangle extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    Offset controlpoint3 = Offset(size.width * 1.3, size.height * 0.4);
    Offset endpoint3 = Offset(size.width * 0.5, size.height * 0);
    Offset controlpoint4 = Offset(size.width * 0.35, size.height * 0);
